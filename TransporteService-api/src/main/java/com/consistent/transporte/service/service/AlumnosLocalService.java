...
/**
 * Provides the local service interface for Alumnos. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AlumnosLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface AlumnosLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link AlumnosLocalServiceUtil} to access the alumnos local service. Add custom service methods to <code>com.consistent.transporte.service.service.impl.AlumnosLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
