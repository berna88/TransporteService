...
/**
 * Provides the local service interface for Edificio. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see EdificioLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface EdificioLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link EdificioLocalServiceUtil} to access the edificio local service. Add custom service methods to <code>com.consistent.transporte.service.service.impl.EdificioLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
