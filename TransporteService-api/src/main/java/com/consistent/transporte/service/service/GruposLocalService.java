...
/**
 * Provides the local service interface for Grupos. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see GruposLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface GruposLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link GruposLocalServiceUtil} to access the grupos local service. Add custom service methods to <code>com.consistent.transporte.service.service.impl.GruposLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
